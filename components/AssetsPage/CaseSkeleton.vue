<template>
  <div v-for="(items) in 3" :key="items" class="flex-col gap-4 w-full flex items-center justify-center  md:h-[calc(100vh-700px)] h-[calc(100vh-150px)] border-2 border-black border-dashed rounded-md">
    <div
